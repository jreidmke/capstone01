...
iep1 = IEP(student_id=1, teacher_id=1, date=date(2019, 9, 2), is_locked=True)
iep2 = IEP(student_id=2, teacher_id=2, is_locked=True)
iep3 = IEP(student_id=3, teacher_id=3, is_locked=True)
